...
func WalletFromMnemonicWithPath(
	mnemonic string,
	mnemonicPath string,
) (*hdwallet.Wallet, accounts.Account, error) {
...
// WalletFromMnemonicWithAccountID returns the wallet with id=accountID, always using the main path
// of derivation.
func WalletFromMnemonicWithAccountID(
	mnemonic string,
	accountID int,
) (*hdwallet.Wallet, accounts.Account, error) {
...
func MnemonicToAddressWithPath(
	mnemonic string,
	hdPath string,
	prefix string,
...
func MnemonicToCosmosAddressWithPath(
	mnemonic string,
	hdPath string,
	prefix string,
) (string, error) {
...
func MnemonicToEthereumAddressWithPath(
	mnemonic string,
	hdPath string,
	prefix string,
) (string, error) {
