...
func (s *SagaOS) Start() (int, error) {
	...
	cmd := fmt.Sprintf("%s start --chain-id %s --home %s --json-rpc.enable true --json-rpc.api eth,txpool,personal,net,debug,web3 --api.enable --grpc.enable >> %s 2>&1", //nolint:lll
